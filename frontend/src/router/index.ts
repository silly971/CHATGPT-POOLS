...
import OpenAIOAuthCallbackView from '../views/OpenAIOAuthCallbackView.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/oauth/openai/callback',
      name: 'openai-oauth-callback',
      component: OpenAIOAuthCallbackView,
    },
    {
      path: '/redeem/common',
      name: 'redeem',
